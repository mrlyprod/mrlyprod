  ...
  return (
    <Page crumb="carry" title="One carry decides how many past terms a diagonal slice needs"
        ...
        <div className="panel">
          ...
          {row && (
            <Stats>
              ...
              <Stat label="root against fill over base">{`${shown(row.read.root)} against ${row.fill} / ${pick.base}`}</Stat>
      ...
      <div className="panel">
        ...
        {row && <Pins terms={row.terms} start={0} label={`level from 0, base ${pick.base}, dimension ${dimension}`} />}
      ...
      <div className="panel">
        ...
        <Sketch draw={parity} deps={[pick.base, dimension]} className="bars" role="img" aria-label="The sign law" />
        <Stats>
