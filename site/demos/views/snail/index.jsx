  ...
  const controls = (
    <>
      ...
      <Group name="The tile">
        ...
        <Pick label="base" value={look.side} options={SIDES.map((q) => [q, q])} onChange={(v) => save({ side: +v })} />
      </Group>
    </>
  );
