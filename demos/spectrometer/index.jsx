...
import { mount, Page, Row, Pick, Check, Btn, Stats, Stat, Note } from '../lib/app.jsx';
...
function App() {
  ...
  return (
    <Page crumb="spectrometer" title="Point the slice at a sponge and it reads the recipe back"
      ...
      foot={<>The spectrum is the crate's Walsh-Hadamard transform of the design's eight corners, the four bars are its level sums <code>Sigma_0</code> to <code>Sigma_3</code>, and the blue curve is the ink law evaluated over the integers in Rust and handed here as an exact numerator over <code>96n^2</code>. The gold dots are the fills the crate counts triangle by triangle on the real mesh, over the <code>6n^2</code> triangles of the hexagon. The two never part: the law predicts the count itself, not an approximation to it. The same hexagon, its mesh census, its pieces and its holes are <a href="../slices">the slices</a> page; the research page this grew from is <a href="https://github.com/mrlyprod/mrlyprod/blob/main/research/slices.md">slices</a>, and the theorem, its proof and its checks are the shelf paper <a href="https://github.com/carlomitchener/carlomitchener/tree/main/research/walsh-spectrometer">the Walsh spectrometer</a>.</>}>
      <Row>
      ...
      <div className="arena">
        ...
        <div className="panel">
          ...
          <Sketch draw={spectrum} deps={[read, sealed]} className="bars" hidden={sealed} />
      ...
      <Sketch draw={law} deps={[read, sealed]} className="bars" />
      <Stats>
