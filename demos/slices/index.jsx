...
import { mount, Page, Row, Pick, Stats, Stat, Note } from '../lib/app.jsx';
...
function App() {
  ...
  return (
    <Page crumb="slices" title="The middle plane of a cube is a hexagon of triangles"
      ...
      <Sketch draw={chart} deps={[view]} onSeek={onSeek} className="bars" />
      <Stats>
