...
function App() {
  ...
  return (
    <Page crumb="radial" title="Stack a design around its centre"
      ...
      foot={<>Each copy is the source turned about its centre; a pixel of the stack averages a few points, each point reading every copy at once and merging them by the blend: their mean, their sum, their union, their meet, their parity, or what the first copy keeps that no other has. The harmonics are exact: every circle about the centre is cut at the grid lines it crosses and the arc integrals of <code>e^(-i m theta)</code> are taken in closed form. Two copies at 45 degrees is the same picture as an afterglow at 900 rpm on a 60 Hz screen with the phase slipping by an eighth of a turn. Which harmonics a turned stack keeps, and the exact circle mean behind them, are in <a href="https://github.com/mrlyprod/mrlyprod/blob/main/research/spin.md">the spin note</a>.</>}>
      <Row>
      ...
      <div className="arena">
        ...
        <div className="panel">
          ...
          <Sketch draw={chart} deps={[view]} className="bars" style={{ height: 300 }} />
