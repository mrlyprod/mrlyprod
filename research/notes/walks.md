...
The generator is `lab/rs/walk-dimension`, which also draws the figure. The [race demo](/demos/race/) runs the experiment live: two base-3 designs of the same fill, random walkers on both at once.
