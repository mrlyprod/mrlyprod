...
def inverse():
    ...
    print()
    print("THE ZERO THAT FORCES THE ABSCISSA, refined on the sibling engine lab/py/design-zeta")
    ...
    print("1/zeta_F(sigma) from lab/py/design-zeta, at sigma above and below Re rho;")
...
def box():
    ...
    sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                    "..", "design-zeta"))
    import design_zeta
    print("WINDING BOXES FOR THE ZEROS OF zeta_F, argument principle on lab/py/design-zeta")
...
def onestep():
    ...
    print("the cost-out crossing of each chord wall is a kept number of lab/rs/mertens-numerology and is not printed here")
    print()
