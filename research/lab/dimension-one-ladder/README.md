...
- `CARGO_BUILD_JOBS=4 cargo run --release --manifest-path research/lab/Cargo.toml -p dimension-one-ladder` runs the carpet and plus to level 18, the sponge to level 16, the census at level 13..16, about two minutes on eight cores.
