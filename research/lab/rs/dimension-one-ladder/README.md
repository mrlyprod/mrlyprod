...
- coprime.md:82 and DISCOVERIES.md:27 the carpet gap halving per level to `-3.52e-07` at level 20, the sponge gap `-3.45e-05` at level 18.
...
- coprime.md:140-142 and DISCOVERIES.md:170 the master bound at order `2K`, the seam `3a` against the level, the constant `2/(1 - 3^(-Lambda_2K/2K)) <= 5.1843`, worst ratio `0.7839` at `(11, 2)` for the order-10 block alone over 833 cases and `0.8755` at `(13, 4)` for the min over all orders, zero violations either way, worst main-range sum over cap `0.8630`.
...
- coprime.md:168 and DISCOVERIES.md:165 the level 13 census `1,044,842 / 1,044,840`, `699,508` singles at 17% of `Z`, `339,530` in `[2,5]` at 55%, ten shifts at 14%, `sum M = 1,577,940`, `max M = 376`.
- coprime.md:169 and DISCOVERIES.md:349 totals `3,151,658`, `9,491,966`, `28,545,342`, peak `occ(8,level)/3^8 = 2.217, 2.492, 2.740`, band exponents `0.5249 / 0.6052, 0.5677, 0.5348 / 0.6096, 0.5765`; coprime.md:159 `Z = 4,003,372 .. 99,800,950` at level 13..16.
