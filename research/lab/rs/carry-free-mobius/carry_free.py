...
def lemma():
    ...
    for q, L in [(2, 15), (3, 10), (4, 8), (5, 7)]:
        ...
        line("   q %2d  to n <= q^L = %10d  mismatches %d  colliding values %d  distinct values %d"
             % (q, q ** L, bad, coll, dis))
    line("")
    line("  the prediction against nu_F, sibling generator lab/py/mrly-pairing verb inverse")
...
def exponent():
    ...
    line("")
    line("  the design mass rate is 2 and q^(Re rho) at base 3 {0,1} is %.6f, lab/py/mrly-pairing verb box" % RHO3)
