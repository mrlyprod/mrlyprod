...
- `DISCOVERIES.md:33` `DISCOVERIES.md:34` - the band, the lattice indices, the `dim 2` constant, the enumerations `0.712853, 0.951771, 0.709137`; the trichotomy counts at odd `base <= 75`, the axes pair, the `{111}` zeros.
