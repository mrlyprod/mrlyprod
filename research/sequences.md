...
|---|---|---|---|
| A000616 | designs up to symmetry, as the dimension grows at base 2: `3, 6, 22, 402, 1228158, 400507806843728` | the shape-class column of the fill-class census; `A000616(3) = 22` is also `design_dim3(2)` | `mrlyrs::math::bang::counting::sequence` |
