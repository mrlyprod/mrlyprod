...
/// let values = mrlyrs::num::spectrum::symmetric_eigenvalues(&m).unwrap();
...
/// let values = mrlyrs::num::spectrum::laplacian_spectrum(&net, true).unwrap();
...
///
/// ```
/// let groups = mrlyrs::num::spectrum::clusters(&[0.0, 1e-15, 2.0], 1e-9);
...
///
/// ```
/// let points = mrlyrs::num::spectrum::spectral_points(&[0.0, 0.5, 0.5, 2.0]);
