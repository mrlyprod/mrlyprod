...
///
/// ```
/// let list = mrlyrs::num::tourbillon::eyes(2);
...
///
/// ```
/// assert_eq!(mrlyrs::num::tourbillon::period(18.0), Some(5));
/// assert_eq!(mrlyrs::num::tourbillon::period(1.0), Some(90));
/// ```
