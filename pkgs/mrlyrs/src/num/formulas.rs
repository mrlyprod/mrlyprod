...
use crate::num::series::harmonic;

pub use crate::num::series::li;
...
///
/// ```
/// assert!((mrlyrs::num::formulas::wallis(1) - 4.0 / 3.0).abs() < 1e-15);
/// ```
...
///
/// ```
/// assert!((mrlyrs::num::formulas::leibniz(2) - 2.0 / 3.0).abs() < 1e-15);
/// ```
...
///
/// ```
/// assert!((mrlyrs::num::formulas::basel(3) - 49.0 / 36.0).abs() < 1e-15);
/// ```
...
///
/// ```
/// assert!((mrlyrs::num::formulas::euler_gamma_partial(1) - 1.0).abs() < 1e-15);
/// ```
...
///
/// ```
/// assert!((mrlyrs::num::formulas::e_partial(1) - 2.0).abs() < 1e-15);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::num::formulas::prime_count(100), 25);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::num::formulas::goldbach(100), 6);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::num::formulas::goldbach_record(10), vec![1, 1, 1, 2]);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::num::formulas::mertens(100), 1);
/// ```
...
mod tests {
    ...
    fn the_five_partials_walk_to_their_constants() {
        ...
        assert!((euler_gamma_partial(200_000) - crate::num::series::EULER).abs() < 1e-5);
