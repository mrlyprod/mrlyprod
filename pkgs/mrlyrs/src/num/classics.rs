...
///
/// ```
/// assert_eq!(mrlyrs::num::classics::catalan(50), vec![1, 2, 5, 14, 42]);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::num::classics::primes(20), vec![2, 3, 5, 7, 11, 13, 17, 19]);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::num::classics::gcd(12, 18), 6);
/// assert_eq!(mrlyrs::num::classics::gcd(7, 0), 7);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::num::classics::reduce(64, 128), (1, 2));
/// ```
