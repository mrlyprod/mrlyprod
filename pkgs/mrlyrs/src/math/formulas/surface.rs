...
use crate::math::formulas::counting::{fill_from_corners, positions};
use crate::num::census::exposed;
...
/// let perimeter: Vec<u128> = (1..5).map(|level| mrlyrs::math::formulas::exposure_of_tile(&carpet, level).unwrap()).collect();
...
/// assert_eq!(mrlyrs::math::formulas::exposure_recurrence(&sponge), [28, -160]);
/// ```
