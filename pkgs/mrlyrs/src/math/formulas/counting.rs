...
///
/// ```
/// assert_eq!(mrlyrs::math::formulas::rational(7, 3, 2, 2, 2).unwrap(), (64, 81));
/// ```
pub fn rational(
    code: Code,
    number: usize,
...
///
/// ```
/// assert_eq!(mrlyrs::math::formulas::limit(7, 2, 1, 2).unwrap(), (3, 4));
/// assert_eq!(mrlyrs::math::formulas::limit(7, 2, 2, 2).unwrap(), (9, 16));
/// ```
