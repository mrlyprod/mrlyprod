...
use crate::num::classics::{factorial, gcd};
use crate::num::factor::{divisors, mobius};
...
///
/// ```
/// assert_eq!(mrlyrs::math::bang::counting::sequence(4).unwrap(), vec![3, 6, 22, 402]);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::math::bang::counting::class_sequence(4), vec![4, 12, 64, 700]);
/// ```
