...
/// assert_eq!(mrlyrs::math::dim::models::dtype_for(255), Dtype::U8);
/// assert_eq!(mrlyrs::math::dim::models::dtype_for(256), Dtype::U16);
/// assert_eq!(mrlyrs::math::dim::models::dtype_for(70000), Dtype::U32);
/// ```
