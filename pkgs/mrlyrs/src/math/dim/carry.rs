...
///
/// ```
/// assert_eq!(mrlyrs::math::dim::carry::digit_polynomial(3, 3).unwrap(), vec![1, 3, 3, 6, 3, 3, 1]);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::math::dim::carry::fill(3, 3).unwrap(), 20);
/// assert_eq!(mrlyrs::math::dim::carry::fill(5, 3).unwrap(), 112);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::math::dim::carry::even_block(3, 3).unwrap(), vec![vec![6, 6], vec![1, 3]]);
/// ```
...
///
/// ```
/// let block = mrlyrs::math::dim::carry::even_block(3, 3).unwrap();
/// assert_eq!(mrlyrs::math::dim::carry::trace(&block), 9);
/// ```
...
/// ```
/// let block = mrlyrs::math::dim::carry::even_block(3, 3).unwrap();
/// assert_eq!(mrlyrs::math::dim::carry::characteristic(&block).unwrap(), vec![1, -9, 12]);
/// ```
...
/// ```
/// let block = mrlyrs::math::dim::carry::even_block(3, 3).unwrap();
/// assert_eq!(mrlyrs::math::dim::carry::determinant(&block).unwrap(), 12);
/// ```
...
///
/// ```
/// let terms = mrlyrs::math::dim::carry::ladder(3, 3, 6).unwrap();
...
/// ```
/// let block = mrlyrs::math::dim::carry::even_block(3, 3).unwrap();
/// let root = mrlyrs::math::dim::carry::perron(&block).unwrap();
...
///
/// ```
/// assert_eq!(mrlyrs::math::dim::carry::sign(3, 3).unwrap(), 1);
/// assert_eq!(mrlyrs::math::dim::carry::sign(3, 4).unwrap(), -1);
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::math::dim::carry::cap(3).unwrap(), 15);
/// assert_eq!(mrlyrs::math::dim::carry::cap(5).unwrap(), 11);
/// ```
