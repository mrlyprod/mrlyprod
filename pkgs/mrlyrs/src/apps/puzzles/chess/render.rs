use super::Chess;
use crate::core::colors::PALETTE;
use crate::core::tensor::Tensor;
use crate::ui::frame::{solid_tile, Frame, Layer, TileSet};
...
impl Chess {
    ...
    fn glyph(&self, mask: &[u8; 25], fg: [u8; 4]) -> crate::math::two::Cell2d {
        ...
        let mut cell = crate::math::two::Cell2d::new(Tensor::of(types, vec![k, k]));
    ...
    pub fn render(&self) -> Frame {
        let k = self.set.tile as usize;
        let mut frame = Frame::new(self.w * k, self.h * k, crate::ui::frame::board(self.dark));
