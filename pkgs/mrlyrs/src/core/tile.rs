...
///
/// ```
/// assert!(mrlyrs::core::tile::uniform(&[3, 3, 3]));
/// assert!(!mrlyrs::core::tile::uniform(&[3, 5, 3]));
/// ```
...
///
/// ```
/// assert_eq!(mrlyrs::core::tile::size(3, 3), Some(27));
/// assert_eq!(mrlyrs::core::tile::size(3, 4294967298), None);
/// ```
