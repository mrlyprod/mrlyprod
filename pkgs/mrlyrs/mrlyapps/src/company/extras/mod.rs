...
pub const SOCIALS: [(&str, &str); 7] = [
    ("instagram", "https://instagram.com/mrlyprod"),
    ("reddit", "https://reddit.com/r/mrlyprod"),
    ("twitter", "https://twitter.com/mrlyprod"),
    ("github", "https://github.com/mrlyprod"),
    ("discord", "https://discord.gg/YEKjjvwhcK"),
    ("tiktok", "https://tiktok.com/@mrlyprod"),
    ("youtube", "https://youtube.com/@mrlyprod"),
];
...
impl App for Extras {
    ...
    fn state(&self, _iden: &Iden, _shape: Option<&Json>) -> Json {
        json!({
            ...
            "cycle": { "lines": LINES.to_vec(), "index": self.index },
            "copyright": COPYRIGHT,
        })
    }
...
mod tests {
    ...
    fn state_carries_the_fixed_content() {
        ...
        assert_eq!(state["socials"][3]["name"], json!("github"));
        assert_eq!(
            state["socials"][3]["url"],
            json!("https://github.com/mrlyprod")
        );
        assert_eq!(state["socials"][4]["name"], json!("discord"));
        assert_eq!(state["socials"][5]["name"], json!("tiktok"));
        assert_eq!(state["socials"][6]["name"], json!("youtube"));
        assert_eq!(
            state["socials"][6]["url"],
            json!("https://youtube.com/@mrlyprod")
        );
