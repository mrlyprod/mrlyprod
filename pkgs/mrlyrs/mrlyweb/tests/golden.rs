...
fn menu_frame_is_golden() {
    let os = boot();
    assert_eq!(os.frame(None).to_json(), fixture("menu"));
}
...
fn calculator_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("calculator"));
}
...
fn notes_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("notes"));
}
...
fn settings_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("settings"));
}
...
fn ui_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("ui"));
}
...
fn life_frame_is_golden() {
    ...
    os.act(Call::new("life.step", json!({})));
    assert_eq!(os.frame(None).to_json(), fixture("life"));
}
...
fn clock_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("clock"));
}
...
fn timer_frame_is_golden() {
    ...
    os.act(Call::new("timer.start", json!({ "secs": 60 })).at(1783600496000));
    os.act(Call::new("timer.check", json!({})).at(1783600556000));
    assert_eq!(os.frame(None).to_json(), fixture("timer"));
}
...
fn calendar_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("calendar"));
}
...
fn dice_frame_is_golden() {
    ...
    os.act(Call::new("dice.roll", json!({})));
    assert_eq!(os.frame(None).to_json(), fixture("dice"));
}
...
fn photos_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("photos"));
}
...
fn shot_frame_is_golden() {
    ...
    os.act(Call::new("sys.shot", json!({})));
    os.act(Call::new("nav.open", json!({ "app": "photos" })));
    assert_eq!(os.frame(None).to_json(), fixture("shot"));
}
...
fn snake_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("snake"));
}
...
fn julia_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("julia"));
}
...
fn mandelbrot_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("mandelbrot"));
}
...
fn matrix_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("matrix"));
}
...
fn sleep_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("sleep"));
}
...
fn ttt_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("ttt"));
}
...
fn memory_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("memory"));
}
...
fn mines_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("mines"));
}
...
fn twenty48_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("twenty48"));
}
...
fn crush_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("crush"));
}
...
fn tennis_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("tennis"));
}
...
fn escape_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("escape"));
}
...
fn quiz_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("quiz"));
}
...
fn captcha_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("captcha"));
}
...
fn pixel_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("pixel"));
}
...
fn solids_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("solids"));
}
...
fn two_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("two"));
}
...
fn three_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("three"));
}
...
fn bang_frame_is_golden() {
    ...
    os.act(Call::new("bang.page", json!({ "dir": "next" })));
    assert_eq!(os.frame(None).to_json(), fixture("bang"));
}
...
fn tile_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("tile"));
}
...
fn six_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("six"));
}
...
fn waves_frame_is_golden() {
    ...
    os.act(Call::new("waves.set", json!({ "key": "damp", "value": 5 })));
    os.act(Call::new("waves.drop", json!({ "x": 2, "y": 2 })));
    os.act(Call::new("waves.step", json!({ "n": 3 })));
    assert_eq!(os.frame(None).to_json(), fixture("waves"));
}
...
fn billiards_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("billiards"));
}
...
fn lasers_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("lasers"));
}
...
fn chess_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("chess"));
}
...
fn font_frame_is_golden() {
    ...
    os.act(Call::new("font.tick", json!({})));
    assert_eq!(os.frame(None).to_json(), fixture("font"));
}
...
fn moire_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("moire"));
}
...
fn hash_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("hash"));
}
...
fn colors_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("colors"));
}
...
fn emoji_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("emoji"));
}
...
fn piano_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("piano"));
}
...
fn extras_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("extras"));
}
...
fn log_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("log"));
}
...
fn files_frame_is_golden() {
    ...
    assert_eq!(os.frame(None).to_json(), fixture("files"));
}
