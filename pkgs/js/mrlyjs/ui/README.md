...
- `chrome.js`: vanilla ESM, runs on load; header buttons, pane state, theme cycle, contents highlight, footer mark; exports `wire()` for pages that render later. Storage keys take the `data-prefix` of `<html>`.
