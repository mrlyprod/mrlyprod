...
/// The three-pen tile skin the board is drawn with.
pub mod skin;
...
/// A paddle, a ball and a seeded wall of blocks that creeps down the board.
pub struct Tennis {
    set: Set,
    rng: Rng,
    seed: u64,
...
impl Tennis {
    /// Serves the first round on seed zero, four full rows of blocks waiting.
    pub fn new() -> Tennis {
        ...
        out.push(Verb::new(
            ...
            json!({
                "key": {
                    ...
                    "scale": "int 2..16",
                    "physics": "int 100..900",
                    "reward_brick": "int -10000..10000",
                    "reward_death": "int -10000..10000",
