...
/// The pieces a pawn may be promoted to, each beside its kind.
...
impl Chess {
    ...
    /// Writes the whole game out as JSON, colors and disguises included.
    ...
    /// Reads a snapshot back, keeping the freshly dealt board if the saved one is malformed.
