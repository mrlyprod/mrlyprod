...
/// Returns the mean fraction of digest bits flipped by a one-bit message change, over the given trials.
...
/// Returns the worst digest bit's drift from a half-and-half balance, in standard deviations.
...
/// Returns the Shannon entropy of digest bytes in bits per byte, over the given trials.
...
/// Returns the digest collisions found across the given trials.
