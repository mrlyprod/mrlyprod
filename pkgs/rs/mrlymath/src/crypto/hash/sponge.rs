...
/// Builds the sponge's starting grid: blank, or a permuted carpet-xor-net weave.
...
/// Absorbs the message into the automaton sponge and squeezes out one entry per digest bit.
