...
/// The working width of the sheet plane.
pub const WIDTH: f32 = 320.0;
/// The working height of the sheet plane.
...
/// Builds the quads of a rimmed plate bored with a cols-by-rows grid of holes.
pub fn sheet(
    cols: usize,
    rows: usize,
    diameter: f32,
...
/// Returns the twelve wire edges of the sheet's box at the given thickness.
