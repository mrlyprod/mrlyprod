/// Unfolds a count of days since the Unix epoch into its civil year, month and day.
///
/// ```
/// assert_eq!(mrlycore::time::civil(0), (1970, 1, 1));
/// assert_eq!(mrlycore::time::civil(-1), (1969, 12, 31));
/// ```
