...
use mrlyskin::draw::{blit, fill_rect, fit};

/// The card raster width in pixels.
pub const WIDTH: usize = 240;
/// The card raster height in pixels.
pub const HEIGHT: usize = 126;
/// The raster-to-PNG upscale factor.
...
/// Paints the share card for a route and title as a WIDTH by HEIGHT RGBA raster.
...
/// Encodes the share card as a PNG upscaled SCALE times.
/// ```
/// let png = mrlyweb::card::card_png("clock", "clock").unwrap();
