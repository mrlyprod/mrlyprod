use super::Os;
use crate::kernel::app::Outcome;
use crate::kernel::envelope::{Notice, Route};
use mrlycore::{json, Json};

impl Os {
    /// Returns the whole world as plain JSON, from route and clock to every app's save.
    ...
    /// Restores the world from frozen JSON, naming the route and apps restored, or refuses a non-object state.
