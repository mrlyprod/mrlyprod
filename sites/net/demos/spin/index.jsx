    ...
    <Page crumb="spin" title="Spin the carpet like a record"
      ...
      <div className="arena">
        <div className="panel">
          ...
          <canvas ref={table} className="sheet" width={SIZE} height={SIZE} role="img" aria-label="The turntable" />
        </div>
        <div className="panel">
          <h2>Infinite speed <span>the exact circle means</span></h2>
          {view && <Pixels data={view.wheel} role="img" aria-label="Infinite speed, the exact circle means" />}
        </div>
      </div>
      <Sketch draw={chart} deps={[view]} className="bars" role="img" aria-label="Circle mean by radius" />
      <Stats>
