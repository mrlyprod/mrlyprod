...
function App() {
  ...
  return (
    <Page bare={art} crumb="words" title="One design per level, and the order of the letters counts"
      ...
      <Sketch draw={drawChart} deps={[chart]} className="bars" hidden={art} role="img" aria-label={pick.chart === 'stair' ? 'The staircase dimension' : 'The component exponent'} />
