    ...
    <Page crumb="zeta" title="Walking the critical line"
      ...
      <div className="arena">
        <div className="panel">
          ...
          <Sketch draw={walk} deps={[head]} role="img" aria-label="The walk, zeta traced in the plane as t grows" />
          <Row>
      ...
      <div className="arena">
        <div className="panel">
          ...
          <Sketch className="bars" draw={stairs} deps={[fold]} role="img" aria-label="The prime staircase against the explicit formula" />
        </div>
      </div>
      <Stats>
