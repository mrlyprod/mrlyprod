    ...
    <Page crumb="spectra" title="A third of the triangle's spectrum sits on a single number"
      ...
      <div className="arena">
        <div className="panel">
          ...
          <Sketch draw={chart} deps={[view]} className="bars" role="img" aria-label="Integrated density of states" />
          <Stats>
            {legend && (
              <>
        ...
        <div className="panel">
          ...
          {view.grid ? <Grid grid={view.grid} on={ink.blue} role="img" aria-label="The object" /> : <Markup svg={view.svg ?? ''} role="img" aria-label="The object" />}
