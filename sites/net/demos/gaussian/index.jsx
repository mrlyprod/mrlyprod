...
function App() {
  ...
  const controls = (
    <>
      ...
      <Group name="A clicked point">
        <Check label="show its units" checked={look.units} onChange={(v) => set({ units: v })} />
      </Group>
      <Group name="Seed">
    ...
    <Page crumb="gaussian" title="Primes in the plane"
      ...
      <div className="arena">
        ...
        <div className="panel">
          ...
          <Sketch draw={chart} deps={[view]} className="bars" role="img" aria-label="The ring weights, one bar per norm" />
          <Stats>
