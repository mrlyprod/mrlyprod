...
function Heat({ scales, grid, clear, row, mate }) {
  ...
  return <Sketch className="bars" draw={draw} deps={[grid, clear, row, mate]} role="img" aria-label="The r-matrix" />;
}
