    ...
    <Page crumb="primes" title="Numbers that will not split"
      ...
      <div className="arena">
        ...
        <div className="panel">
          ...
          <Sketch draw={stones} deps={[pile]} role="img" aria-label="The stones, one rectangle per divisor pair" />
        </div>
        <div className="panel">
          <h2>Counting primes <span>the staircase and its two guesses</span></h2>
          <Sketch draw={chart} deps={[data]} className="bars" role="img" aria-label="Counting primes, the staircase and its two guesses" />
        </div>
        <div className="panel">
          <h2>The witness <span>one bar per earlier odd scale</span></h2>
          <Sketch draw={witness} deps={[trial]} className="bars" role="img" aria-label="The witness, one bar per earlier odd scale" />
        </div>
      </div>
      <Stats>
