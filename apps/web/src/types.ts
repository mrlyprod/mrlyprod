...
export type Glyph = { x: number; y: number; k: number; ch: string; tint?: string }
...
export type Node =
  ...
  | { kind: "Canvas"; key?: string; handle: string; rows?: number[][]; cells?: Cells & { app: string }; palette?: string[]; glyphs?: Glyph[]; tris?: number[]; shade?: Shade; strip?: Flip[]; tap?: Call; drag?: Call; turn?: Call; zoom?: Call; pan?: Call; grid?: [number, number] }
