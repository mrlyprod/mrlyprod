...
const routes: Record<string, HTMLBundle | (() => Response)> = {
  "/": index,
  "/mrlyjs_bg.wasm": () =>
    new Response(Bun.file(`${here}/../../pkgs/mrlyjs/web/pkg/mrlyjs_bg.wasm`), { headers: NO_STORE }),
  "/mrlyjs.js": () =>
    new Response(Bun.file(`${here}/../../pkgs/mrlyjs/web/pkg/mrlyjs.js`), { headers: NO_STORE }),
}
