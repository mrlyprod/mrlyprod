...
import { BASE, CATALOG, DESIGNER, ORDERS } from "../src/lib/site"
...
const { site } = scan(APP)
const routes = ["", ...Object.keys(site.products), DESIGNER.route, ...Object.keys(site.pages), CATALOG.route, ORDERS.route]
