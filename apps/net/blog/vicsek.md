...
the catch and the fix are recorded in
`research/mrlymath/lab/sequences/vicsek_perimeter/RUN.txt`.
...
line is `a(n) = 2*A034474(n)`, now recorded in
[the sequence ledger](https://git.mrly.net/research/mrlymath/sequences).
