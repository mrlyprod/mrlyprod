...
MRLYFONT = os.path.join(ROOT, "pkgs", "rs", "mrlyfont", "assets")
...
def ui_icons():
    with open(os.path.join(ROOT, "pkgs", "js", "mrlyui", "src", "Glyphs.tsx"), encoding="utf-8") as f:
...
MANIFEST = {
    "net": {
        "public": "sites/net/public",
        "brand": ["favicon.ico", "mark.svg", "icons/mrly_192_192.png", "icons/mrly_512_512.png"],
    },
    "git": {
        "public": "sites/git/public",
        "brand": ["favicon.ico", "mark.svg", "icons/mrly_192_192.png", "icons/mrly_512_512.png"],
    },
    "bot": {
        "public": "sites/bot/public",
        "brand": ["favicon.ico", "mark.svg", "icons/mrly_192_192.png", "icons/mrly_512_512.png"],
    },
    "web": {
        "public": "sites/web/public",
...
PACKAGES = {
    "pkgs/js/mrlyui/styles/faces.css": UI_FACES,
}
...
def mark():
    return mp.read(mp.boot("full"), "fonts/glyphs/X")
...
def bundle():
    target = os.path.join(ROOT, "pkgs", "js", "mrlyui", "styles", "fonts")
    ...
    write(os.path.join(ROOT, "pkgs", "js", "mrlyui", "styles", "faces-local.css"), sheet(UI_FACES, shared(urls)))
