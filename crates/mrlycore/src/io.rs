...
pub use crate::codec::png;

/// Maps a slice of type bytes through a colorizer into rgba pixels.
...
/// Snaps every color in a grid to its nearest palette entry, or an error on an empty palette.
...
/// The visual class of a grid's pixels.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Kind {
    /// Pure black and white.
    Binary,
    /// Equal channels throughout.
    Grayscale,
    /// At least one colored pixel.
    Color,
}

/// The visual summary of one grid.
...
pub struct Analysis {
    ...
    pub dominant: Color,
    /// The mean luminance across all pixels.
    pub mean_luminance: f64,
    /// The darkest pixel's luminance.
    pub min_luminance: f64,
    /// The brightest pixel's luminance.
...
/// Classifies a grid's pixels and reports the dominant color and luminance bounds.
