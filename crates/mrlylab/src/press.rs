...
///
/// ```
/// assert_eq!(mrlylab::press::usage(0, 2, 2), 1);
/// assert_eq!(mrlylab::press::usage(6, 2, 2), 0b0110);
/// ```
...
///
/// ```
/// let members: Vec<u128> = (0..30).filter(|&n| mrlylab::press::member(0b0111, n, 2, 2)).collect();
...
///
/// ```
/// assert_eq!(mrlylab::press::containing(6, 2, 2), 4);
/// ```
...
///
/// ```
/// assert_eq!(mrlylab::press::coordinates(6, 2, 2), vec![1, 2]);
/// ```
...
///
/// ```
/// assert_eq!(mrlylab::press::members(0b10, 1, 2, 5), vec![1, 3, 7, 15, 31]);
/// ```
...
///
/// ```
/// assert_eq!(mrlylab::press::count_below(0b0111, 2, 2, 27), 18);
/// ```
